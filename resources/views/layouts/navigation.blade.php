<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('answers.index')" :active="request()->routeIs('answers.*')">
                        {{ __('My Answers') }}
                    </x-nav-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <div class="text-right me-4">
                    ...
                    <p class="text-sm font-semibold text-gray-800 dark:text-gray-100">{{ $activeCompany->name ?? 'Demo SME Co.' }}</p>
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('answers.index')" :active="request()->routeIs('answers.*')">
                {{ __('My Answers') }}
            </x-responsive-nav-link>
